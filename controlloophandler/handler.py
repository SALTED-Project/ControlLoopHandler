...
class ControlLoopHandler():
    ...
    def __init__(self, det_component_id: str, starting_params: dict, token_endpoint,mqtt_endpoint,mqtt_port,auth_client_id,auth_client_secret):
    ...
    def start(self) -> None:
        ...
        self.__client.connect(self.__mqtt_endpoint, self.__mqtt_port, 60)
